...
class MiniWindow(QDialog):
    ...
    def __init__(self, actuator, expand_callback, config):
        ...
        self.address_input.setPlaceholderText(_("Enter a Templecoin address or contact"))
        ...
        self.setWindowTitle("Electrum-TPC")
...
class ReceivePopup(QDialog):
    ...
    def setup(self, address):
        label = QLabel(_("Copied your Templecoin address to the clipboard!"))
        ...
        self.setWindowTitle("Electrum - " + _("Receive Templecoin payment"))
